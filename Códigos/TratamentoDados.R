...
## O que está ao lado da hashtag representa informação faltante.
...
table(empilhado10$HISTFAMC) #9; #0;
...
# Trocando as datas vazias pelo final da COORTE 
...
# Calculando tempo decorrido até o início do tratamento
